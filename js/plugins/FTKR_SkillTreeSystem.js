 ...
 * @desc 指定控制菜单栏的开/关显示的开关ID。
 * @default 0
 * @type number
 *
 * @param Enable Confirmation
 * @desc 你想在确认屏幕上确认该技能已被学会吗？
 *  1 - 确认, 0 - 不确认
 * @default 1
 * @type number
 *
 * @param Reset When Forgotten Skill
 * @desc 当你忘记一个技能的时候，重新设定树？
 * 1 - 重新设置, 0 - 没有重置
 * @default 1
 * @type number
 * 
 * @param Learned Actor Var ID
 * @desc 指定一个变量ID，以存储学习了该技能的演员的ID。
 * @default 0
 * @type number
 *
 * @param Learned Skill Var ID
 * @desc 指定变量ID来存储所学技能的ID。
 * @default 0
 * @type number
 *
 * @param --设定学习的次数(Learned Count)--
 * 
 ...
 * @desc 当你的等级提高时，你获得的SP数量
 * @default 1
 * @type number
 * 
 * @param Cost Sp Icon
 * @desc 指定当费用设置为SP时要显示的图标。
 * @default 296
 * @type number
 *
 * @param Hide Sp Cost 0
 * @desc 当SP成本为零时，在成本窗口中隐藏SP成本吗
 * 0 - 显示, 1 - 隐藏
 * @default 0
 * @type number
 * 
 ...
 * @desc 未入队在战斗中获胜时获得的SP量的百分比(%)
 * @default 100
 * @min 0
 * @max 100
 * @type number
 * 
 * @param --设置技能框架(Skill Frame)--
 * 
 ...
 * @desc 图标相对于技能框架的Y坐标位置
 * @default 4
 * @min -4096
 * @max 4096
 * @type number
 * 
 * @param --技能文本(Skill Text)--
 * 
 ...
 * @desc 技能名称相对于技能框架的Y坐标位置
 * @default 2
 * @min -4096
 * @max 4096
 * @type number
 * 
 * @param --设置技能框架的颜色(Skill Frame Color)--
 * 
 ...
 * @desc 具有所需费用或缺失条件的技能的框架颜色
 * @default 16
 * @type number
 * 
 * @param --显示课程数量的设置(Skill Count Frame)--
 * 
